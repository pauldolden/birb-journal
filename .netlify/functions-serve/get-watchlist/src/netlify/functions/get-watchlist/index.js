...
// netlify/functions/get-watchlist/index.ts
var get_watchlist_exports = {};
__export(get_watchlist_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_watchlist_exports);
...
var handler = async (event) => {
  ...
  const { data, error } = await supabase.from("media").select("*").eq("type", (_b = event.queryStringParameters) == null ? void 0 : _b.type).eq("watched", false);
  if (error) {
